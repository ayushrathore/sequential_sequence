...
void main()
{
    ...
    c=L1(&head1);
    void Insert3(int element1,int element2)
    {
    ...
    void Insert4(int element1,int element2,int count)
    {
        struct Node2* temp=(struct Node2*)malloc(sizeof(struct Node2));
        temp->element1=element1;
        temp->element2=element2;
    ...
    void InsertCount(int *temp,int count)
    {
        struct Node2* temp2=*temp;
        temp2->count=count;
    }
    int Search(int search1,int search2)
    {
        int count=0;
        for(i=0;i<5;i++)
        {
